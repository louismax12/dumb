# Let's write the complete, industry-standard System Design and Implementation Plan into a markdown file.
# The content will be detailed, professional, and entirely in Indonesian as requested.

md_content = """# System Design & Implementation Plan: Interactive World Cup AI Photobooth System
...
* **Response Success (201 Created):**
    ```json
    {
      ...
      "data": {
        "photo_id": "wb-78b1c9",
        "download_url": "[https://yourdomain.com/d/wb-78b1c9](https://yourdomain.com/d/wb-78b1c9)",
...
with open("system_design_implementation_plan_photobooth.md", "w", encoding="utf-8") as f:
